...
@Entity
@Table(name = "TMediumFilm")
public class MediumFilm extends Film {
    private String director;

    @ElementCollection
    @CollectionTable(name = "MediumFilm_Genders")
    @Column(name = "gender")
    private List<String> gendersList;
    private int ageRating;

    public MediumFilm() {}
    public MediumFilm(Integer code, String title, Integer duration, String director, List<String> gendersList, int ageRating) {
